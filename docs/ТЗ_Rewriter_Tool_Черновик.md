...
**Статус:** v0.4 — расширено по заметкам об обогащении данных, правках
рерайтера, эволюции промпта, SEO/тегах и микросервисной архитектуре
(2026-08-01); архитектурные решения v0.3 не пересматриваются, только
дополняются
...
- **AuditLog** — actor, действие, сущность, время, детали изменения,
  включая обязательный enum причины Reject/NeedsFix (§4.13) и факт
  подтверждения лицензии обложки (§4.17).
