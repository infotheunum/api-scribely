...
def save_draft(
    ...
    patch = drafts_api.DraftPatch(
        ...
        og_title_ru=og_title_ru,
        og_description_ru=og_description_ru,
        slug_ru=slug_ru,
